...
\textbf{Movimiento Oscilatorio Armónico Simple:} La ecuación que define un movimiento oscilatorio es una ecuación diferencial ordinaria de segundo orden de la siguiente forma:
...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[scale=0.8]{energOscil.eps}
